...
每一次的修改，必须遵循以下原则：
全局规范：
1、能复用代码，必须复用，避免冗余代码，不要生成我要你之外的代码。
2、不需要你主动测试，你完成代码就行，我自己会测试；
3、代码要添加详细的注解；
4、遵循现有的目录结构，规范创建新文件
前端规范：
1、前端代码每一个元素都必须带上一个随机id，方便我告你问题
2、能复用组件就复用组件
3、按照页面业务，放到对应的src/main/resources/static/js/pages和src\main\resources\static\css\pages，粒度要细，放置一个文件过大
java后端规范
